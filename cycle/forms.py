...
from cycle.models import Cycle, Cycle_in_obj, Client, Objectives
...
class ObjectivesForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(ObjectivesForm, self).__init__(
...
ObjectivesFormSet = inlineformset_factory(
    Cycle_in_obj, Objectives, form=ObjectivesForm, extra=1, can_delete=True, )
...
class CycleInObjForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(CycleInObjForm, self).__init__(
            *args, **kwargs)  # Call to ModelForm constructor
...
class SamplingForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self.fields['Number_of_Exceptions'].required = False
        # self.fields['Sample_Exception_Rate'].required = False
        # self.fields['Computed_Upper_Exception_Rate'].required = False
...
class ICMatrix(forms.Form):
    ...
    objectives = Objectives.objects.all().values_list(
        'transaction_objective', flat=True)
    ...
    def __init__(self, *args, **kwargs):
        ...
        for i in range(2):
            self.fields['option_%d' % i] = forms.ChoiceField(
...
class NewCycleForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(NewCycleForm, self).__init__(
            *args, **kwargs)  # Call to ModelForm constructor
...
BaseICProcFormset = inlineformset_factory(
    Mxcell, Test_of_Controls, form=TOCForm, extra=1, can_delete=True)
...
class samples_form(forms.Form):
    ...
    sampling_method = forms.ChoiceField(choices=Sampling_CHOICES, initial={
                                        'sampling_method': 'Random'}, required=False)
...
class TOC_Form(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['deficient'] = forms.ChoiceField(
            label="Deficient or Not?", widget=forms.RadioSelect(), choices=self.Option_CHOICES)
