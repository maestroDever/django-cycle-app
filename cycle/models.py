...
class Objectives(models.Model):  # Build
    ...
    cycle = models.ForeignKey(
        Cycle_in_obj, related_name="has_objectives", on_delete=models.CASCADE)
    transaction_objective = models.CharField(max_length=100, unique=True)
...
class samples(models.Model):
    ...
    Actual_Sample_Size = models.ForeignKey(
        Test_of_Controls, related_name="Actual_Sample_Size", on_delete=models.CASCADE)
